...
![](/img/user/24-渗透/HMV/assets/Pasted image 20241130215126.png)
**Gpt分析**
![585](/img/user/24-渗透/HMV/assets/Pasted image 20241130215318.png)
...
![](/img/user/24-渗透/HMV/assets/Pasted image 20241130224842.png)
...
尝试一下 发现确实是账号密码
利用账号密码成功通过认证
![](/img/user/24-渗透/HMV/assets/Pasted image 20241130225142.png)
...
![](/img/user/24-渗透/HMV/assets/Pasted image 20241201001719.png)
```python
#coding:utf-8
import os
import cPickle
...
![](/img/user/24-渗透/HMV/assets/Pasted image 20241201004318.png)
```bash
